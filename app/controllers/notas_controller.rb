...
#                @ano_letivo = [ (session[:ano]- 7).to_s, (session[:ano]- 6).to_s, (session[:ano]- 5).to_s, (session[:ano]- 4).to_s,(session[:ano]- 3).to_s,(session[:ano]- 2).to_s,(session[:ano]- 1).to_s]
#            else if  session[:classe_nota] == 7
#                    @ano_letivo = [(session[:ano]- 6).to_s, (session[:ano]- 5).to_s, (session[:ano]- 4).to_s,(session[:ano]- 3).to_s,(session[:ano]- 2).to_s,(session[:ano]- 1).to_s]
#                else if  session[:classe_nota] == 6
#                        @ano_letivo = [ (session[:ano]- 5).to_s, (session[:ano]- 4).to_s,(session[:ano]- 3).to_s,(session[:ano]- 2).to_s,(session[:ano]- 1).to_s]
#                    else if  session[:classe_nota] == 5
#                            @ano_letivo = [  (session[:ano]- 4).to_s,(session[:ano]- 3).to_s,(session[:ano]- 2).to_s,(session[:ano]- 1).to_s ]
#                        else if  session[:classe_nota] == 4
#                                @ano_letivo = [  (session[:ano]- 3).to_s,(session[:ano]- 2).to_s,(session[:ano]- 1).to_s]
#                            else if  session[:classe_nota] == 3
#                                    @ano_letivo = [  (session[:ano]- 2).to_s,(session[:ano]- 1).to_s]
#                                else if  session[:classe_nota] == 2
#                                        @ano_letivo = [  (session[:ano]- 1).to_s]
#                                    else if  session[:classe_nota] == 1
#                                            @ano_letivo = [  ]
#                                        end
#                                    end
#                                end
...
#        end
    ...
    def edit
        ...
        k = session[:new2_aluno_id]= @nota.aluno_id

        z = session[:id_nota] = params[:id]
