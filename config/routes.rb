ActionController::Routing::Routes.draw do |map|
  ...
  map.consultar_avaliacoes_periodo '/consultar_avaliacoes_periodo', :controller => 'atividades', :action => 'consultar_avaliacoes_periodo'
  map.consulta_avaliacaos '/consulta_avaliacaos', :controller => 'atividades', :action => 'avaliacao_consulta'
  map.consulta_avaliacaos_periodo '/consulta_avaliacaos_periodo', :controller => 'atividades', :action => 'avaliacao_consulta_periodo'
  ...
  map.consultaatividade '/consultaatividade', :controller => 'atividades', :action => 'consultaatividade'
